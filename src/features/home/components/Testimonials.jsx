...
const testimonials = [
  ...
  { id: 2, quote: "The Workshop2Outreach Program gave me the opportunity to turn what I learned into meaningful community impact. Through the program, I successfully implemented the MotherWell Initiative and provided physiotherapy education to pregnant and postpartum women in Rwanda. The mentorship and support I received strengthened my leadership and project implementation skills. I am grateful for the experience and look forward to creating even greater impact in the future.", source: "DUHIREYEZU Idesbald" },
  { id: 3, quote: "Women's health is important to me because I get to learn and understand my body, and in turn help other women understand and navigate all the peculiarities that come with being a woman.", source: "Eniola Anjola-Ade Ojuko" },
  { id: 4, quote: "Women’s health is important to me because it is an area that is most often overlooked. As a physiotherapist, I want to contribute to better care, awareness, and support for women through this field.", source: "Temiloluwa Akanle" },
  { id: 5, quote: "Women’s health is important to me because the health of women directly affects the health of families and communities.When women have access to appropriate health care, education, and support, it improves not only their personal quality of life but also the health, development, and stability of the communities around them.", source: "Gold Enioluwafe Oluleye" },
  { id: 6, quote: "Women are an integral part of the community, there's a need for us to prioritize our health, to function maximally for ourselves and the community at large.", source: "Mariam Jubril" },
  { id: 7, quote: "Women Health is important to me because it provides me the opportunity to contribute positively to the health and wellness of women around me", source: "Oluwadare, Gloria Jesutofunmi" },
  { id: 8, quote: "It was an impactful and wonderful journey ", source: "Fauziyya Haruna Aliyu" },
  { id: 9, quote: "The experience was intriguing, I got to challenge myself to do new things and I also got the support to keep going even when it looked like the programme wouldn't happen", source: "Aliyu Fatimah Oluwatoyin" },
