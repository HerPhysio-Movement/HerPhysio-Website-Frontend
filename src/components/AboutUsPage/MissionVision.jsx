        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-white/50">
            ...
            <h4 className="text-xl sm:text-2xl font-bold text-[#1D2130] mb-4 leading-tight">
              To reshape the narrative of women's health physiotherapy in
              Africa.
            </h4>
            ...
            <blockquote className="text-[#525560] italic border-l-4 border-[#FD90A7] pl-4">
              “We speak in a way that makes women feel seen, heard, and
              empowered – without judgment or jargon.”
            </blockquote>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-white/50">
            ...
            <p className="text-[#525560] mb-6 leading-relaxed">
              Our vision is to be the trusted guide for women at every stage of
              life. We combine clinical expertise with culturally relevant,
              simple language to bridge the gap between medical knowledge and
              real‑life health experiences.
            </p>
            <blockquote className="text-[#525560] italic border-l-4 border-[#FD90A7] pl-4">
              “Physiotherapy is not a luxury – it's a necessity. We're here to
              make it accessible to every woman.”
            </blockquote>
          </div>
        </div>
